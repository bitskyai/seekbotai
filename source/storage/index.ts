import { createRxDatabase, RxDatabase, RxChangeEvent } from 'rxdb';
...
export default async function getDatabase() {
  if (_smartBookmarsDatabase) { return _smartBookmarsDatabase; }
  ...
  _smartBookmarsDatabase.tags.$.subscribe(async ()=>{
    console.log(await _smartBookmarsDatabase.tags.find().exec().then(tags => {
