...
function getCleanEnv(overwriteProcessEnv?: object): AppOptions {
  ...
  const spec = {
    ...
    DESKTOP_APP_EXTENSIONS_PATH: str({
      default: DEFAULT_APP_OPTIONS.DESKTOP_APP_EXTENSIONS_PATH,
    }),
    DESKTOP_APP_TOUR_PATH: str({
      default: DEFAULT_APP_OPTIONS.DESKTOP_APP_TOUR_PATH,
    }),
  ...
  return {
    ...
    DESKTOP_APP_EXTENSIONS_PATH: envValues.DESKTOP_APP_EXTENSIONS_PATH,
    DESKTOP_APP_TOUR_PATH: envValues.DESKTOP_APP_TOUR_PATH,
